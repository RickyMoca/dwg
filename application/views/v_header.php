...
<head>
    ...
    <script src="<?= base_url(); ?>assets/vendor/js/plugins/notifications/jgrowl.min.js"></script>
    <script src="<?= base_url(); ?>assets/vendor/js/plugins/notifications/noty.min.js"></script>
    <script src="<?= base_url(); ?>assets/vendor/js/demo_pages/extra_jgrowl_noty.js"></script>
